...
namespace HISPlus.Utils
{
    class WordUtils
    {
        ...
        public string StartTime { get { return SelectedRow["BStartTime"].ToString(); } set { return; } }
        
        public byte[] ReportFileID 
        {
            get
            {
                DBHelper dbh = new DBHelper(ConnectionStrings.HisPlusDB);
                return dbh.InsertFileDataToDB(FileName);
            }
        }
        ...
        public bool HasSpecimen
        {
          get
            {
              if ((int)SelectedRow["SpecimenYesNo"] == 0)
                  return false;
               else
                  return true; 
            }
        ...
        public int SpecimenQty { get { return (int)SelectedRow["SpecimenNumber"]; } set { return; } }
       ...
       // Microsoft.Office.Interop.Word.Application wordApp = null;
        ...
        private bool InsertOrEdit(int serial, string opDate, string opStartTime)
        {
            ...
            if (opDate != "")
                filters.Add(string.Format(" Date LIKE N'%{0}%' ", opDate));
            if (opStartTime != "")
        ...
        public void InsertToDB ()
        {
            ...
            drOperationReport["ReportFileDataID"] = ReportFileID;
            ...
            drOperationReport["CreatorUserID"] = CreatorUserID;
