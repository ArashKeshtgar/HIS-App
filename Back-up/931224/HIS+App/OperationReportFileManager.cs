...
namespace HISPlus
{
    class OperationReportFileManager
    {
        ...
        public DataRow SetDetailReportRow(DataRow detailReportRow)
        {
            ...
            insertDetailReportToDB.ReportFileData = dbHelper.SaveOpReportToDB( _wordDoc);
        ...
        private class OpReportDocContentControls
        {
            ...
            public string Indcation
            {
                get
                {
                    if (GetContentControlValue("Indcation").ToString() != "")
            ...
            public string Finding
            {
                get
                {
                    if (GetContentControlValue("Finding").ToString() != "")
            ...
            public string Procedure
            {
                get
                {
                    if (GetContentControlValue("Procedure").ToString() != "")
        ...
        internal void InsertDetailRepor(Document docBeforeSave)
        {
            ...
            insertReportRow["Serial"] = _reception.Serial;
            insertReportRow["OpDate"] = _reception.OpDate;
            insertReportRow["StartTime"] = _reception.StartTime;
            insertReportRow["ReportFileData"] = dbHelper.SaveOpReportToDB(docBeforeSave);
            insertReportRow["CreateTime"] = DateTime.Now;
            insertReportRow["CreatorUserID"] = 1;
            insertReportRow["PreOpDiagnosis"] = _reception.PreDiagnosis;
            insertReportRow["PostOpDiagnosis"] = _reception.PostDiagnosis;
            insertReportRow["KindOfOperation"] = _reception.KindOfOperation;
            insertReportRow["HasSpecimen"] = _reception.HasSpecimen;
            insertReportRow["SpecimenQty"] = _reception.SpecimenNumber;
            insertReportRow["Indication"] = _reception.OpIndication;
            insertReportRow["Finding"] = _reception.OpFinding;
            insertReportRow["OpProcedure"] = "OpProcedure";

            dbHelper.Insert(insertReportRow, da);
        }
    }
}
